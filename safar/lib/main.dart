...
import 'package:safar_frontend/locator.dart';
import 'package:safar_frontend/route/route_handler.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    MaterialColor primarySwatch = MaterialColor(0xFF131313, InToMaterialColors.color);
    return ScreenUtilInit(
      ...
      builder: (_,child){
        return MaterialApp(
          ...
          initialRoute:'/',
          navigatorKey: locator<DynamicNavigationService>().navigatorKey,
