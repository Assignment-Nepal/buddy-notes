...
class Config {
  ...
  static get BUDDY_SERVER => _conf[_Config.BUDDY_SERVER];
}

class _Config {
  static const ENVIRONMENT = "ENVIRONMENT";
  static const BUDDY_SERVER = "SPOCK_SERVER";
  ...
  static Map<String, dynamic> localConf = {
    ENVIRONMENT: 'local',
    BUDDY_SERVER: localEmulator5000,
  };

  static Map<String, dynamic> debugConf = {
    ENVIRONMENT: 'debug',
    BUDDY_SERVER: 'http://apidev.buddyserver.me:5000/',
  };

  static Map<String, dynamic> stagingConf = {
    ENVIRONMENT: 'staging',
    BUDDY_SERVER: 'https://apidev.buddyserver.me',
  };

  static Map<String, dynamic> productionConf = {
    ENVIRONMENT: 'production',
    BUDDY_SERVER: 'https://api.buddyserver.me',
